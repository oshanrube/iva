<?php
namespace Acme\NotificationsBundle\Library\Includes\XMPPHP;
/**
...
class BOSH extends XMPP {
		...
		public function loadSession() {
			if(isset($_SESSION['BOSH_RID'])) $this->rid = $_SESSION['BOSH_RID'];
			if(isset($_SESSION['BOSH_SID'])) $this->sid = $_SESSION['BOSH_SID'];
			if(isset($_SESSION['BOSH_authed'])) $this->authed = $_SESSION['BOSH_authed'];
			if(isset($_SESSION['BOSH_jid'])) $this->jid = $_SESSION['BOSH_jid'];
			if(isset($_SESSION['BOSH_fulljid'])) $this->fulljid = $_SESSION['BOSH_fulljid'];
		}

		public function saveSession() {
			$_SESSION['BOSH_RID'] = (string) $this->rid;
			$_SESSION['BOSH_SID'] = (string) $this->sid;
			$_SESSION['BOSH_authed'] = (boolean) $this->authed;
			$_SESSION['BOSH_jid'] = (string) $this->jid;
			$_SESSION['BOSH_fulljid'] = (string) $this->fulljid;
		}
}
