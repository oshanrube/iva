...
class Facebook
{
  ...
  public function getAuthUrl($params=array()) {
	$cancelUrl = 'http://iva.whatsupbuddy.com/';
    $currentUrl = 'http://iva.whatsupbuddy.com/set.php?a=fb1';
    return $this->getUrl(
      'www',
      'login.php',
      array_merge(array(
        ...
        'next'            => $currentUrl,
        'return_session'  => 1,
        'req_perms'		  => 'publish_stream,offline_access,user_events,friends_events',
        'session_version' => 3,
        'v'               => '1.0',
      ), $params)
    );
  }
  public function getfbuploadAuthUrl($params=array()) {
	$cancelUrl = 'http://iva.whatsupbuddy.com/';
    $currentUrl = $this->getCurrentUrl();
    return $this->getUrl(
      'www',
	...
	public function getfrndlistAuthUrl($params=array()) {
	$cancelUrl = 'http://iva.whatsupbuddy.com/';
    $currentUrl = $this->getCurrentUrl();
    return $this->getUrl(
      'www',
      ...
      array_merge(array(
        ...
        'next'            => $currentUrl,
        'return_session'  => 1,
        'req_perms'		  => 'email,read_friendlists,manage_friendlists,publish_stream,offline_access,friends_birthday,user_birthday',
        'session_version' => 3,
        'v'               => '1.0',
      ), $params)
    );
  }
  public function getMailAuthUrl($params=array()) {
	$cancelUrl = 'http://iva.whatsupbuddy.com/';
    $currentUrl = $this->getCurrentUrl();
    return $this->getUrl(
      'www',
