<?php
namespace Acme\UserBundle\Library\Google;
/*
...
use Acme\UserBundle\Library\Google\config;
//require_once ".php";
...
use Acme\UserBundle\Library\Google\service\apiModel;
use Acme\UserBundle\Library\Google\service\apiService;
use Acme\UserBundle\Library\Google\service\apiServiceRequest;
use Acme\UserBundle\Library\Google\auth\apiAuth;
use Acme\UserBundle\Library\Google\cache\apiCache;
use Acme\UserBundle\Library\Google\io\apiIO;
use Acme\UserBundle\Library\Google\service\apiMediaFileUpload;
use Acme\UserBundle\Library\Google\cache\apiFileCache;
/*
...
class apiClient {
  ...
  public function __construct($config = array()) {
    ...
    $aa = new $apiConfig['cacheClass']();exit();
